 ...
 * @param <M>
 */
public abstract class LingLingBaseDao<T extends Serializable, M extends BaseEntity> extends SqlSessionDaoSupport implements IDao<T, M> {
    ...
    @Resource
    public void setSqlSessionFactoryLingLing(SqlSessionFactory sqlSessionFactory) {
